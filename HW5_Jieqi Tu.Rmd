...
From the result, we could see that, when a is a small value, this method works fine. However, when we increase the value of a, the result is much more deviated from the theoretical value.
